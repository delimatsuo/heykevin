...
`2026-09-25T13:45:15Z` displays **Ready for Distribution**, **Review Completed**,
and selected build **42**. The
[dated public-release update](releases/2026-09-17-app-store-ios-42.md#public-release-update--september-25-2026)
preserves the earlier submission observations and their dates.
Production health at `2026-09-25T12:49:41Z` still reports the revision and SHA
below; that read does not repeat the September 17 traffic/runtime audit.
Public availability and physical-phone acceptance remain separate:
...
confirms version 1.3.2 is now available, released September 18.
...
1.3.0 (39); the current public baseline is 1.3.2, as recorded above.
...
TestFlight QA availability. The current public baseline is **1.3.2**, as
