...
The native design is published to the App Store in **1.3.0 (39)**; its
[release record](../releases/2026-09-15-native-frontend-ios-39.md) contains the
compiled-app and public release evidence, while physical phone acceptance remains separate.
