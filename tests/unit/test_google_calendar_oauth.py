"""Google Calendar OAuth remains durable and least-privileged."""
...
def test_google_calendar_oauth_uses_freebusy_only_scope():
    assert integrations.GOOGLE_CALENDAR_SCOPE == "https://www.googleapis.com/auth/calendar.freebusy"
...
async def test_callback_preserves_existing_refresh_token_and_records_expiry(monkeypatch):
    ...
    assert contractor.data["google_calendar_scope"] == "https://www.googleapis.com/auth/calendar.freebusy"
