...
FORBIDDEN_ENV_NAMES = {
    ...
    "INTEGRATION_TOKEN_ACTIVE_KEY_VERSION", "INTEGRATION_TOKEN_ENCRYPTION_KEYS",
    "JOBBER_CLIENT_ID", "JOBBER_CLIENT_SECRET", "TELEGRAM_BOT_TOKEN", "TELEGRAM_WEBHOOK_SECRET",
